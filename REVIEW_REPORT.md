...
**Sprzątanie kosmetyczne — kiedyś:** 4. `tsconfig` `jsx: preserve` (#8) 5. try/catch w middleware (#9) 6. Obsługa błędów `signInWithOAuth` (#10) 7. Wykluczenie `/api/webhooks/*` z matchera (#11) 8. Popraw `package.json.description` i wzmiankę o `middleware.ts` w CLAUDE.md (#13, #14)
