  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <section className="mt-8 space-y-4 text-neutral-700 dark:text-neutral-300">
        ...
        <ul className="list-disc space-y-1 pl-6">
          <li>Jokusorzy realizujący Twoje zlecenia (w zakresie potrzebnym do wykonania usługi).</li>
          ...
          <li>Dostawcy OAuth (Google, Facebook, Apple) — wyłącznie w zakresie uwierzytelnienia.</li>
