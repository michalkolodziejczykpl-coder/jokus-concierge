...
-- delivery
('package-pickup', 'Odbiór paczki', 'Odbiór paczki od kuriera (DPD, DHL, InPost, GLS, UPS) i dostarczenie pod drzwi.', 'delivery', 'Package', 8.00, 'fixed', 20, false, false, '[{"key":"tracking_number","label":"Numer śledzenia","type":"text","required":true},{"key":"pickup_location","label":"Skąd odebrać (paczkomat/punkt)","type":"text","required":true}]'::jsonb, 1),
